...
do
  ...
  assert((a.what == "C" and a.short_src == "[C]") or (a.what == "Go" and a.short_src == "[Go]"))
...
-- TODO or spec have no plan to support getlocal for GoFunction
...
-- TODO or spec plua produce different byte codes
...
-- TODO or spec getregistry is not implemented
