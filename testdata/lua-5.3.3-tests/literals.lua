...
local function lexerror (s, err)
  ...
  -- TODO or spec no need to guarantee that it returns the same error as clua's one.
  -- assert(not st and string.find(msg, "near .-" .. err))
  assert(not st and msg ~= "")
end
...
for i = 0, 255 do
  if i ~= 35 then -- TODO or spec initial '#' is handled specially
...
-- TODO or support no plan to support "\r", "\n\r" as line break
-- for i, n in pairs{"\n", "\r", "\n\r", "\r\n"} do
for i, n in pairs{"\n", "\r\n"} do
...
-- TODO or spec setlocale is not implemented
