...
-- TODO or spec lua's document says 'These indices are corrected following the same rules of function string.sub.', so this is wrong.
...
-- TODO or spec
	-- print(string.format("%+.2A", 12), "^%+0X%x%.%x0P%+?%d$")
